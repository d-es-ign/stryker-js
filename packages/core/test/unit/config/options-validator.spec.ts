...
describe(OptionsValidator.name, () => {
  ...
  describe('plugins', () => {
    it('should be invalid with non-array plugins', () => {
      breakConfig('plugins', '@d-es-ign/stryker-js-typescript');
      actValidationErrors(
  ...
  describe('appendPlugins', () => {
    it('should be invalid with non-array plugins', () => {
      breakConfig('appendPlugins', '@d-es-ign/stryker-js-typescript');
      actValidationErrors(
  ...
  describe('reporters', () => {
    it('should be invalid with non-array reporters', () => {
      breakConfig('reporters', '@d-es-ign/stryker-js-typescript');
      actValidationErrors(
