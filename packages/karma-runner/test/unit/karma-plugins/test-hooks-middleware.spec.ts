    ...
    describe('perTest', () => {
      it('should throw if the current test framework is not supported', () => {
        ...
        expect(() => sut.configureCoverageAnalysis('perTest')).throws(
          'Could not configure coverageAnalysis "perTest". Your test framework is not supported by the `@d-es-ign/stryker-js-karma-runner`. Supported test frameworks: mocha, jasmine',
        );
      });
