...
describe('Coverage analysis', () => {
  ...
  describe('with the jasmine-runner', () => {
    beforeEach(() => {
      ...
      strykerOptions.plugins.push(
        import.meta.resolve('@d-es-ign/stryker-js-jasmine-runner'),
      );
  ...
  describe('with the cucumber-runner', () => {
    beforeEach(() => {
      ...
      strykerOptions.plugins.push(
        import.meta.resolve('@d-es-ign/stryker-js-cucumber-runner'),
      );
    });
    describeTests();
  });
  ...
  describe('with the jest-runner', () => {
    beforeEach(() => {
      ...
      strykerOptions.plugins.push(
        import.meta.resolve('@d-es-ign/stryker-js-jest-runner'),
      );
  ...
  describe('with mocha-runner', () => {
    beforeEach(() => {
      ...
      strykerOptions.plugins.push(
        import.meta.resolve('@d-es-ign/stryker-js-mocha-runner'),
      );
    });
    describeTests();
  });
  ...
  describe('with vitest-runner', () => {
    beforeEach(() => {
      ...
      strykerOptions.plugins.push(
        import.meta.resolve('@d-es-ign/stryker-js-vitest-runner'),
      );
    });
  ...
  describe('with karma-runner', () => {
    ...
    beforeEach(() => {
      ...
      strykerOptions.plugins.push(
        import.meta.resolve('@d-es-ign/stryker-js-karma-runner'),
      );
